...
class DisplayPipeline:
    ...
    def DrawGradientHatch (self, hatch : Hatch, colors : Set(Color), stops : Set(Single), point1 : Point3d, point2 : Point3d, linearGradient : bool, repeat : Single, boundaryThickness : Single, boundaryColor : Color) -> None: ...
    def DrawGradientMesh (self, mesh : Mesh, colors : Set(Color), stops : Set(Single), point1 : Point3d, point2 : Point3d, linearGradient : bool, repeat : Single) -> None: ...
...
class DrawObjectEventArgs:
    ...
    def GetHashCode (self) -> int: ...
    def GetType (self) -> Type: ...
class CalculateBoundingBoxEventArgs:
    @property
    def BoundingBox (self) -> BoundingBox: ...
