...
class ViewCaptureWriter:
    ...
    def Draw (self, constPtrPrintInfo : IntPtr) -> None: ...
class TextFields:
    def Notes () -> str: ...
    def NumPages () -> int: ...
    def PageNumber () -> int: ...
...
class VectorGradientProc:
    def __init__(self, object : Object, method : IntPtr): ...
    def Invoke (self, pEngine : IntPtr, pHatch : IntPtr, strokeWidth : Single, gradientCount : int, colors : IntPtr, stops : IntPtr, points : IntPtr, linearGradient : int, boundaryColor : int) -> None: ...
