...
class RenderPlugInList:
    ...
    @Item.setter
    def Item (self, index : int, value : RenderPlugInInfo) -> None: ...
    ...
    def CopyTo (self, array : Set(RenderPlugInInfo)) -> None: ...
    def CopyTo (self, index : int, array : Set(RenderPlugInInfo), arrayIndex : int, count : int) -> None: ...
    def CopyTo (self, array : Set(RenderPlugInInfo), arrayIndex : int) -> None: ...
